...
public class PaymentService {
    ...
    public PaymentService(OrderRepository orderRepository, OrderItemsRepository orderItemRepository, CartRepository cartRepository) {
    ...
    public String createOrder(int userId, BigDecimal totalAmount, List<OrderItem> cartItems) throws RazorpayException {
    	...
    	// step-1A....instantitae razorpayClient using keyid and keysecret generated by razorpay api
        ...
        // step-3 return order if created for making payment
